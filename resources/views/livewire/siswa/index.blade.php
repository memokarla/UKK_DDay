                ...
                <tbody>
                    @forelse ($siswas as $key => $siswa)
                        <tr class="bg-white border-b border-gray-200 hover:bg-yellow-100">
                            ...
                            <td class="px-6 py-4">
                                <!-- [kondisi] ? [benar] : [salah] -->
                                <img class="rounded-full w-12 h-12 object-contain shadow-lg" 
                            ...
                            <td class="px-6 py-4">
                                {{ $siswa->gender ? \Illuminate\Support\Facades\DB::select("select getGenderDescription(?) AS gender", [$siswa->gender])[0]->gender : 'Gender tidak tersedia' }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $siswa->rombel ? \Illuminate\Support\Facades\DB::select("select getRombelDescription(?) AS rombel", [$siswa->rombel])[0]->rombel : 'Rombel tidak tersedia' }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $siswa->alamat }}
                            </td>
